...
import "../About/clip_aboutImage.css";
...
export default function HeroAboutImage({ className }: { className?: string }) {
  return (
    <motion.div
      ...
      whileHover="hover"
      className={cn(
        "blob-border hidden h-[31vw] w-[31vw] place-items-center overflow-hidden md:grid",
        className,
      )}
    >
